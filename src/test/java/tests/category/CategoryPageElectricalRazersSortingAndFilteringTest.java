...
public class CategoryPageElectricalRazersSortingAndFilteringTest extends BaseTest {
    ...
    public void shouldSortInDescendingOrderAndFilterByName() {
        ...
        steps.navigateToCategory(Categories.ELECTRICAL_RAZERS);
        testProductsSortingAndFiltering(Categories.ELECTRICAL_RAZERS, Brands.BRAUN);
    }
}
